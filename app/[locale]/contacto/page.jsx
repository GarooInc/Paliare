        ...
        <main className="flex min-h-screen w-full pt-28 bg-white">
            <div className='flex flex-col w-full lg:justify-center justify-start items-center'>
                <form className="py-20 bg-black flex flex-col justify-center items-center lg:w-1/2 w-full">
                    <h1 className="tittle text-center text-white anton">{t('contact_title')}</h1>
                    <div className="flex flex-col justify-between items-center gap-2 lg:w-1/2 w-2/3">
                        ...
                        <button className="mont btn border-2 border-white w-full mt-10 hover:bg-white hover:text-black">{t('contact_form_send')}</button>
                    </div>
                </form>
                <div className="flex flex-col lg:w-1/3 w-full py-10 gap-4">
                    <span className="subtitle_mid text-center text-black">{t('contact_subtitle_1')}</span>
                    <span className="text-3xl mont text-center font-semibold text-black uppercase">{t('contact_subtitle_2')}</span>
                </div>
            </div>
            <LanguageSwitcher />
        </main>
