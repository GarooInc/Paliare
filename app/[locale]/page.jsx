    ...
    return (
        ...
        <main className="flex min-h-screen w-full flex-col">
            ...
            <section className="normal_section bg-white pt-20 lg:pt-40 lg:pb-0">
                <div className='flex md:flex-row flex-col justify-start items-center w-full gap-8 md:h-[500px]'>
                    ...
                    <div className='flex flex-col justify-start items-center gap-4 md:w-1/3 h-full'>
                        <span className='subtitle_mid text-black md:text-start tracking-wider'>{t('homepage_section_4_subtitle')}</span>
                        <span className="small_subtitle text-black  md:text-start tracking-wider">{t('homepage_section_4_text_1')} </span>
                        <span className="small_subtitle text-black  md:text-start tracking-wider" dangerouslySetInnerHTML={{ __html: boldUppercase(t('homepage_section_4_text_2')) }}></span>
                        <a  href="/filosofia" className="text-black subtitle_mid underline font-medium w-full md:text-start tracking-wider">{t('homepage_section_4_kwnowmore')}</a>
                    </div>
                </div>
            </section>
            <section className="normal_section bg-white py-10 lg:pt-0">
                    ...
                    <div className='flex flex-col lg:justify-center justify-start items-center text-center gap-4 lg:gap-10 lg:py-10'>
