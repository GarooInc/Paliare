            ...
            images.map((image, index) => (
                <div key={index} id={index} className="carousel-item flex justify-center w-full relative">
                    ...
                    <div className='xs:hidden lg:block'>
                      {
                        images[index+1] ? <a href={`#${index+1}`} className="absolute top-1/2 right-10 transform -translate-y-1/2"> <IoIosArrowRoundForward className='text-white text-4xl'/> </a> : <a href={`#0`} className=" absolute top-1/2 right-10 transform -translate-y-1/2"> <IoIosArrowRoundForward className='text-white text-4xl'/> </a>
                      }
                      ...
                      <div className="absolute bottom-20 right-20 text-white text-2xl font-light mont w-1/3 flex flex-col">
                        ...
                        <a href='/' className="text-white text-lg font-medium underline mont"> {t('homepage_section_2_slides_more') }</a>
                      </div>
                    </div>
