    ...
    <div className="w-full">
        {
                images.map((image, index) => (
                    <div key={index} id={index} className="carousel-item flex justify-center w-full relative">
                        ...
                        <div className='flex flex-col absolute lg:top-1/2 top-40 gap-6 justify-center items-center lg:px-0 px-8'>
                            <h1 className="text-white lg:text-6xl text-4xl font-regular m-0 anton uppercase text-center tracking-widest">{image.title}</h1>
