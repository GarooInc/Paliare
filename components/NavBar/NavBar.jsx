...
const NavBar = ({primary, transparent, black, namepage}) => {
  ...
  return (
    <header className={transparent ? "absolute inset-x-0 top-0 z-50 bg-transparent" : `lg:block inset-x-0 top-0 ${primary ? 'md:bg-white bg-transparent absolute z-50 md:relative' : 'bg-white'}`}>
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          {
            namepage && (
              <div className="text-center lg:m-0 mr-16 lg:block hidden">
          ...
          {
            namepage && (
              <div className="text-center block lg:hidden absolute top-20 inset-0">
                <h1 className={transparent && !black ? "page_title text-white" : "page_title text-black"}>{t(`header:${namepage}`)}</h1>
              </div>
            )
          }
